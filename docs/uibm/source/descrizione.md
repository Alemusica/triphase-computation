...
The phit-based PRNG was tested against NIST SP 800-22 statistical test suite on 10 million 64-bit samples. All tests passed, with per-bit entropy measured at 100% (64.0/64.0 bits).
...
## INDUSTRIAL APPLICABILITY / APPLICABILITA INDUSTRIALE
...
FIG. 6 — Table of experimental results on Apple M1 Max (Sections 3.4 and 4.2).

FIG. 7 — Diagram showing phase-gated encryption and decryption flow (Section 5).

---

## PRIOR ART REFERENCES / RIFERIMENTI ARTE NOTA

...
| Test | Risultato | Metrica |
|------|-----------|---------|
| Monobit | SUPERATO | Z-score < 3,29 |
| Runs | SUPERATO | Z-score < 3,29 |
| Distribuzione Byte | SUPERATO | Chi-quadro = 221,7 (< valore critico 310) |
...
| Metrica | Valore |
|---------|--------|
| Chi-quadro | 7,8 (soglia di uniformità: 14,07) |
| Throughput di routing | 28 Mroute/s |
| Sbilanciamento massimo del carico | 2,5% |
...
|---------|-------------------|-------------------|---------------|
| Tempo per lettura | ~100 ns | ~0,3 ns (1 ciclo) | ~300x |
| Phit per lettura | ~2 | ~8-16 | ~4-8x |
